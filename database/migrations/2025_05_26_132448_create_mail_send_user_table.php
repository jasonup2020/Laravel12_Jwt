...
return new class extends Migration
{
    ...
    {
        Schema::create('mail_send_user', function (Blueprint $table) {
            $table->comment('对外发送邮件基础信息');
            $table->id();
            ...
            $table->tinyInteger('mail_mark')->default(1)->comment('状态:0停用,1启用');
    ...
    {
        Schema::dropIfExists('mail_send_user');
    }
};
